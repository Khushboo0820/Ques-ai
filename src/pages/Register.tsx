      ...
      <div className="hidden md:flex flex-col auth-container text-white p-12 justify-center relative overflow-hidden">
        <div className="relative z-10 max-w-md">
          ...
          <h1 className="text-5xl font-display font-bold leading-tight mb-4">
            Join the community of podcasters today.
          </h1>
          
          <p className="text-xl opacity-90 mb-8">
            Create an account and start growing your podcast with AI-powered insights.
          </p>
        ...
        <div className="max-w-md w-full mx-auto">
          <div className="flex flex-col items-center mb-8">
            ...
            <h2 className="text-2xl font-semibold text-center">
              Create your <span className="text-purple-500">Ques.AI</span> account
            </h2>
          </div>
